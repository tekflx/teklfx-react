...
const footerNavigation = {
    services: [
      ...
      { name: 'Recruitment', href: '/services/recruit' },
      { name: 'Security', href: '/services/security' },
      { name: 'Due Diligence', href: '/services/due-diligence' },
      { name: 'R&D Activities', href: '/services/sred' },
    ],
    technology: [
      { name: 'Core Languages', href: '/tech/languages' },
      { name: 'Data', href: '/tech/data' },
      { name: 'Infrastructure', href: '/tech/infrastructure' },
      { name: 'Media Services', href: '/tech/media' },
    ...
    social: [
      ...
      {
        name: 'LinkedIn',
        href: 'https://linkedin.com/company/tekflx/',
        icon: (props) => (
          <svg fill='currentColor' viewBox='0 0 24 24' {...props}>
          ...
          <div className='max-w-md mx-auto pt-12 px-4 sm:max-w-7xl sm:px-6 lg:pt-16 lg:px-8'>
            <div className='xl:grid xl:grid-cols-3 xl:gap-8'>
              <div className='space-y-8 xl:col-span-1'>
                <img
                  className='h-10'
                  src='/img/mark-gray-300.svg'
                  alt='Tekflx'
                />
                <p className='text-gray-500 text-base'>
                  Helping companies flex their tech.
                </p>
